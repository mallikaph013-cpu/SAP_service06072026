        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedByName = table.Column<string>(type: "TEXT", maxLength: 120, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IssueDescription = table.Column<string>(type: "TEXT", maxLength: 500, nullable: false),
                    ...
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    UpdatedByName = table.Column<string>(type: "TEXT", maxLength: 120, nullable: true),
                    ApproverDepartment = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    ApproverUserId = table.Column<string>(type: "TEXT", maxLength: 450, nullable: false),
                    ApproverName = table.Column<string>(type: "TEXT", maxLength: 150, nullable: false),
                    SecondApproverUserId = table.Column<string>(type: "TEXT", maxLength: 450, nullable: true),
                    SecondApproverName = table.Column<string>(type: "TEXT", maxLength: 150, nullable: true),
                    ThirdApproverUserId = table.Column<string>(type: "TEXT", maxLength: 450, nullable: true),
                    ThirdApproverName = table.Column<string>(type: "TEXT", maxLength: 150, nullable: true),
                    ApprovalLevel = table.Column<int>(type: "INTEGER", nullable: false),
                    AssignedItUserId = table.Column<string>(type: "TEXT", maxLength: 450, nullable: false),
                    AssignedItName = table.Column<string>(type: "TEXT", maxLength: 150, nullable: false),
                    RequesterUserId = table.Column<string>(type: "TEXT", maxLength: 450, nullable: true),
                    DocumentNo = table.Column<string>(type: "TEXT", maxLength: 20, nullable: true)
                },
                constraints: table =>
                {
